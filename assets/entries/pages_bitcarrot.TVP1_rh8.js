  ...
  try {
    ...
    if (sponsor) {
      ...
      if (!sponsorUpdate.ok) {
        ...
        throw new Error(errBody.message || 'Failed to harvest BitCarrot.');
      }
      showResult('success', 'BitCarrot Harvested!', 'BitCarrot from ' + sponsor + ' added to ' + badge + '. Total: ' + newCount + '.');
    } else {
